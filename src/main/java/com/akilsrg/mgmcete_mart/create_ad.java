                        ...
                        reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                database.getReference().child("product").push().setValue(model)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                ...
                                                Toast.makeText(create_ad.this,"Product Uploaded Successfully",Toast.LENGTH_SHORT).show();
                                ...
                                if (TextUtils.isEmpty(str1)) {
                                    ed1.setError("Please enter your product name");
                                    ed1.requestFocus();
                                    return;
                                }

                                if (TextUtils.isEmpty(str2)) {
                                    ed2.setError("Please enter your product description");
                                    ed2.requestFocus();
                                    return;
                                }
                                if (TextUtils.isEmpty(str3)) {
                                    ed3.setError("Please enter your product price");
                                    ed3.requestFocus();
                                    return;
                                }
